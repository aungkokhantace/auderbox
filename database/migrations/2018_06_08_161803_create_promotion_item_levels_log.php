...
class CreatePromotionItemLevelsLog extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('promotion_item_levels_log', function (Blueprint $table) {
          $table->increments('id');
    ...
    {
        Schema::drop('promotion_item_levels_log');
    }
}
