    ...
    public function run()
{
    ...
    $roles = array(
      ...
      ['id'=>3, 'user_name'=>'admin_auderbox','display_name'=>'Starfish Administrator', 'password' =>'$2y$10$y57lFUd93SHOmCWJ8lZYROtnWQMxK90uos31q17Lhgfmc4fzgaDO6', 'email' =>'admin_auderbox@gmail.com','role_id' =>'3','staff_id'=>'0002','address'=>'','description'=>'This is admin role'],
